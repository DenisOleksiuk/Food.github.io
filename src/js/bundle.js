...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! (webpack)/buildin/global.js */ "C:\\Users\\i\\AppData\\Roaming\\npm\\node_modules\\webpack\\buildin\\global.js")))
...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/service */ "./src/js/services/service.js");
...
function cards() {
  ...
  Object(_services_service__WEBPACK_IMPORTED_MODULE_5__["getResource"])('http://localhost:3000/menu').then(function (data) {
...
/* harmony import */ var _modals__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modals */ "./src/js/modules/modals.js");
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/service */ "./src/js/services/service.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_service__WEBPACK_IMPORTED_MODULE_10__["postData"])('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    Object(_modals__WEBPACK_IMPORTED_MODULE_9__["openModal"])('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      Object(_modals__WEBPACK_IMPORTED_MODULE_9__["closeModal"])('.modal');
    }, 4000);
  }
}
...
function closeModal(modaleSelector) {
  var modal = document.querySelector(modaleSelector);
...
function modals(triggerSelector, modaleSelector, modalTimerId) {
  ...
  modalTrigger.forEach(function (btn) {
    btn.addEventListener('click', function () {
      return openModal(modaleSelector, modalTimerId);
    });
  });
...
function sliders(_ref) {
  ...
  if (slides.length < 10) {
    // если наших блоков со слайдами меньше 10 то прибавляем 0 к началу строки
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return Object(_modules_modals__WEBPACK_IMPORTED_MODULE_4__["openModal"])('.modal', modalTimerId);
  }, 30000);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2020-09-16');
...
var getResource = /*#__PURE__*/function () {
  ...
  return function getResource(_x3, _x4) {
